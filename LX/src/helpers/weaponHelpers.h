...
namespace weapons
{
	inline static std::array<uint32_t, 0x6B> all_weapon_hashes = {
		...
		0x57A4368C, //weapon_gadgetpistol
		...
		0x88374054, //weapon_snspistol_mk2
		0x8BB05FD7, //weapon_flashlight
		0x917F6C8C, //weapon_navyrevolver
		...
		0x97EA20B8, //weapon_doubleaction
		...
		0xBA536372, //weapon_hazardcan
		0xBD248B55, //weapon_minismg
		0xBFD21232, //weapon_snspistol
		0xBFE256D4, //weapon_pistol_mk2
		...
		0xCB96392F, //weapon_revolver_mk2
		...
		0xDB26713A, //weapon_emplauncher
		0xDBA2E809, //weapon_metaldetector
