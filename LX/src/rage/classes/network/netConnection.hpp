...
#pragma pack(push, 8)
	...
	public:
		enum class Type
		{
			NET_EVENT_CONNECTION_REQUESTED,			// A connection was requested from a remote endpoint.
			NET_EVENT_CONNECTION_ESTABLISHED,		// A connection was established.
			NET_EVENT_CONNECTION_ERROR,				// There was an error on the connection.
			NET_EVENT_CONNECTION_CLOSED,			// A connection was closed.
			NET_EVENT_FRAME_RECEIVED,				// A frame of data was received.
			NET_EVENT_ACK_RECEIVED,					// An ack for a previously sent frame was received.
			NET_EVENT_BANDWIDTH_EXCEEDED,			// Bandwidth limit was exceeded.
			NET_EVENT_OUT_OF_MEMORY					// Ran out of memory.
		};
