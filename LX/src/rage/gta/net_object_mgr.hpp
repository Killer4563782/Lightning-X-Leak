...
namespace rage
{
	...
	public:
		...
		virtual void HandleCloneCreateAck(::CNetGamePlayer* source, ::CNetGamePlayer* target, uint16_t object_flags, NetObjectAckCode ack_code) = 0;
		...
		virtual void HandleCloneSyncAck(::CNetGamePlayer* source, ::CNetGamePlayer* target, void*, uint16_t objectId, NetObjectAckCode ack_code) = 0;

		virtual void HandleCloneRemove(::CNetGamePlayer* source, ::CNetGamePlayer* target, uint16_t object_id, int) = 0;
		virtual void HandleCloneRemoveAck(::CNetGamePlayer* source, ::CNetGamePlayer* target, uint16_t object_id, NetObjectAckCode ack_code) = 0;
...
public:
	...
	{
		return g_pointers->g_get_net_object(this, object_id, can_delete_be_pending);
	}
};
